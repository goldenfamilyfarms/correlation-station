...
from arda_app.api import (
    v1_cid_router, v4_cid_router, v5_cid_router, v1_isp_router, v3_isp_router,
    v1_design_router, v1_design_new_router, v1_design_mac_router, v2_remedy_router,
    v1_tools_router, atlas_router, v1_internal_router,
)
...
# NEW: OpenTelemetry initialization
from common_sense.telemetry import init_telemetry
import os
...
class APIRouter(FastAPIRouter):
    def add_api_route(self, path: str, endpoint: Callable[..., Any], *, include_in_schema: bool = True, **kwargs: Any) -> None:
        if path.endswith("/"):
