...
class AppConfig(BaseSettings):
    """
    Environment settings for Beorn
    """
...
class AuthConfig(BaseSettings):
    """
    Environment settings for Authentication of Beorn services
    ...
    # Hydra
    BEORN_HYDRA_KEY: str = ""
    BEORN_HYDRA_KEY_SKELLY: str = ""
    BEORN_HYDRA_STAGIUS_KEY: str = ""
    BEORN_HYDRA_STAGIUS_KEY_SKELLY: str = ""
...
class UrlConfig(BaseSettings):
    """
    Environment settings for Beorn Service Urls
    """
    ...
    def populate_ise_cubes(self) -> "UrlConfig":
        ...
        # Populate ISE Cube URLs (East, West, South) based on the environment
    ...
    def set_granite_url(self) -> "UrlConfig":
        ...
        self.HYDRA_BASE_URL = self.envs[os.environ.get("USAGE_DESIGNATION")]["DENODO"]
        return self
