...
class StartClass:
    ...
    param_dictionary = {
        ...
        "test_to_perform": "ra_commit_error_check",
        # error_test_list - Choose errors codes of interest to run test on 
        "error_test_list": ["DE-1110", "DE-1119", "DE-1144"],
        ...
        # room name = MDSO_Commit_Error_Report
        "webex_room_id": "Y2lzY29zcGFyazovL3VzL1JPT00vZWIwYWU3YjAtNzI3My0xMWVlLTkzMTUtNzU0ZWViYTcxZTI4",
