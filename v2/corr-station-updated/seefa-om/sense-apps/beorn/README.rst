...
3. Create a virtual environment(Nomenclature depends on how you install python)
    - py3 | ```python3 -m venv beorn_venv```
    - py  | ```python -m venv beorn_venv```

4. Activate your virtual environment
    - Mac(Bash) | ```source beorn_venv/bin/activate```
    - Windows(Powershell) | ```.\beorn_venv\Scripts\activate```
...
3. No module named <module_name>
    ...
    - If you still encounter this error activate your virtual environment in cli and in VSCODE
