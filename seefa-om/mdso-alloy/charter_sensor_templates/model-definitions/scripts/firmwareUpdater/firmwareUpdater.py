...
_import_logger.info("firmwareUpdater.py: Attempting to import OTelMixin from scripts.otel.otel_mixin")
try:
    from scripts.otel.otel_mixin import OTelMixin
    _import_logger.info("firmwareUpdater.py: Successfully imported OTelMixin")
except ImportError as e:
    _import_logger.error(f"firmwareUpdater.py: Failed to import OTelMixin - Error: {e}")
    raise
