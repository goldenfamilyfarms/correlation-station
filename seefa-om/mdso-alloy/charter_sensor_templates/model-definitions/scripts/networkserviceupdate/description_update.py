...
_import_logger.info("description_update.py: Attempting to import OTelMixin from scripts.otel.otel_mixin")
try:
    from scripts.otel.otel_mixin import OTelMixin
    _import_logger.info("description_update.py: Successfully imported OTelMixin")
except ImportError as e:
    _import_logger.error(f"description_update.py: Failed to import OTelMixin - Error: {e}")
    raise
