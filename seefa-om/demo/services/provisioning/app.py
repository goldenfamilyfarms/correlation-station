...
resource = Resource.create({"service.name": "sense-provisioning"})
...
DATA_FILE = os.path.join(os.path.dirname(__file__), '..', 'mock', 'data', 'eline.json')
