...
os.environ["MS_NAME"] = "ARDA"
logger = logging.getLogger(__name__)


class AppConfig(BaseSettings):
    """
    Environment settings for Arda
    """
...
class AuthConfig(BaseSettings):
    """
    Environment settings for Authentication of Arda services
    ...
    # Hydra
    ARDA_ADVA_RAD_HYDRA_KEY: str = ""
    ARDA_ADVA_RAD_HYDRA_KEY_SKELLY: str = ""
    ARDA_HYDRA_KEY: str = ""
    ARDA_HYDRA_KEY_SKELLY: str = ""
    ARDA_NOC_HYDRA_KEY: str = ""
    ARDA_NOC_HYDRA_KEY_SKELLY: str = ""
    ARDA_HYDRA_STAGIUS_KEY: str = ""
    ARDA_HYDRA_STAGIUS_KEY_SKELLY: str = ""
...
class UrlConfig(BaseSettings):
    """
    Environment settings for Arda Service Urls
    """

    envs: dict = {
        "PRODUCTION": {"GRANITE": "https://hydra-vip.chtrse.com/prod"},
        "STAGE": {"GRANITE": "https://hydra-dev.chtrse.com"},
    }

    # URLs
    # Prod and Dev different
    ...
    def set_granite_url(self) -> "UrlConfig":
        self.GRANITE_BASE_URL = self.envs[os.environ.get("USAGE_DESIGNATION")]["GRANITE"]
        return self
